...
export type ReasonCode =
  ...
  | 'MISSING_IN_RDC' | 'OUTSIDE_RDC_PERIOD_PRESENT_IN_CUSTOMER' | 'OUTSIDE_PERIOD_PRESENT_IN_RDC'
  | 'RDC_BEFORE_CUSTOMER_LEDGER_START' | 'AMOUNT_MISMATCH'
